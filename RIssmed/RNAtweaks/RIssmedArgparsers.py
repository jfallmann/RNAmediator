...
def parseargs_plcons():
    parser = argparse.ArgumentParser(description=
                                     'Calculate base pairing probs of given seqs or random seqs for given window size, '
                                     'span and region.')
    ...
    parser.add_argument("-r", "--unconstraint", type=str, default='STDOUT',
                        help='Print output of unconstraint folding to file with this name')
    parser.add_argument("-n", "--unpaired", type=str, default='STDOUT',
                        help='Print output of unpaired folding to file with this name')
    parser.add_argument("-p", "--paired", type=str, default='STDOUT',
    ...
    parser.add_argument("-x", "--constrain", type=str, default='sliding',
                        help='Region to constrain, either sliding window (default) or region to constrain (e.g. 1-10) '
                             ...
                             'sequence from fasta]')
    parser.add_argument("-y", "--conslength", type=int, default=1,
                        help='Length of region to constrain for sliding window')
    parser.add_argument("-t", "--temprange", type=str, default='',
    ...
    parser.add_argument("-g", "--genes", type=str, default='',
    ...
    parser.add_argument("--loglevel", type=str, default='WARNING',
                        choices=['WARNING', 'ERROR', 'INFO', 'DEBUG'], help="Set log level")
...
def parseargs_collectpl():
    ...
    parser.add_argument("-p", "--pattern", type=str, default='250,150',
                        help='Pattern for files and window, e.g. Seq1_30,250')
    parser.add_argument("-c", "--cutoff", type=float, default=.2,
    ...
    parser.add_argument("-b", "--border", type=float, default=0.0,
    ...
    parser.add_argument("-u", "--ulimit", type=int, default=1,
    ...
    parser.add_argument("--loglevel", type=str, default='WARNING', choices=['WARNING','ERROR','INFO','DEBUG'],
                        help="Set log level")
    parser.add_argument("--logdir", type=str, default='LOGS', help="Set log directory")
    parser.add_argument("-w", "--padding", type=int, default=1,
...
def parseargs_foldcons():
    ...
    parser.add_argument("-y", "--conslength", type=int, default=0,
...
def visualiziation_parser():
    ...
    parser.add_argument("-m", "--memory", action="store_true", help="Will store database in memory overrides tmp flag")

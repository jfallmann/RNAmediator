...
# Logging
import datetime
from RNAmediator.Tweaks.logger import makelogdir, setup_multiprocess_logger
...
##load own modules
from RNAmediator.Tweaks.RNAmediatorArgparsers import *
from RNAmediator.Tweaks.Randseq import createrandseq

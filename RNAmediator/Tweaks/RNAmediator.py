...
import gzip
from RNAmediator.Tweaks.RNAtweaks import get_location
...
@check_run
def add_rnamediator_constraint(
    ...
    logid = f"{SCRIPTNAME}.add_rnamediator_constraint"
    cons_list = []
...
@check_run
def rnamediator_logging_setup(logdir: str, loglevel: str, runscript: str):
